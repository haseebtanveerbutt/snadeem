...
{{--        </li>--}}
        <li class="card-header-tab">
            <a class=" @if(isset($selected_filter) && $selected_filter =="all") active @endif all" data-filtertype="all"
               href="javascript:void(0)" data-shopid="{{$user->id}}">All</a>
        </li>
        <li class="card-header-tab">
            <a href="javascript:void(0)"
        ...
        <li class="card-header-tab">
            <a href="javascript:void(0)"
               ...
               data-filtertype="partial" data-shopid="{{$user->id}}">Partial</a>
        </li>
        ...
        <li class="card-header-tab">
            <a href="javascript:void(0)"
               ...
               data-filtertype="paid" data-shopid="{{$user->id}}">Paid</a>
        </li>
        <li class="card-header-tab">
            <a href="javascript:void(0)"
               class="@if(isset($selected_filter) && $selected_filter =="unpaid") active @endif unpaid"
               data-filtertype="unpaid" data-shopid="{{$user->id}}">Unpaid</a>
        </li>
    </ul>
</div>
<div class="card-body">
    ...
    <div class="row no-margins card-body-section">
        <div class="col-12" style="position: relative">
            <input name="search" value="{{isset($search)?$search:null}}" class="form-control filter-order-by-search"
