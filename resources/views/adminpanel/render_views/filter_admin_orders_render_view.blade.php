    ...
    <div class="card-header-actions">
        <ul class="card-header-tabs">
            <li class="card-header-tab">
                <a class=" @if(isset($selected_filter) && $selected_filter =="all") active @endif all" data-filtertype="all" href="javascript:void(0)" data-shopid="{{$shop_id}}">All</a>
            </li>
            <li class="card-header-tab">
                <a href="javascript:void(0)" class="@if(isset($selected_filter) && $selected_filter =="unfulfilled") active @endif unfulfilled" data-filtertype="unfulfilled"  data-shopid="{{$shop_id}}" >Unfulfilled</a>
            </li>
            <li class="card-header-tab">
                <a href="javascript:void(0)" class="@if(isset($selected_filter) && $selected_filter =="partial") active @endif partial" data-filtertype="partial" data-shopid="{{$shop_id}}" >Partial</a>
            </li>
            <li class="card-header-tab">
                <a href="javascript:void(0)"  class="@if(isset($selected_filter) && $selected_filter =="paid") active @endif paid" data-filtertype="paid" data-shopid="{{$shop_id}}">Paid</a>
            </li>
            <li class="card-header-tab">
                <a href="javascript:void(0)" class="@if(isset($selected_filter) && $selected_filter =="unpaid") active @endif unpaid" data-filtertype="unpaid" data-shopid="{{$shop_id}}">Unpaid</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
        ...
        <div class="row no-margins card-body-section">
            <div class="col-12">
                <input name="search" class="form-control filter-order-by-search" data-href="{{route('admin.filter.search.orders',$shop_id)}}"  placeholder="Filter Orders e.g #1001">
            </div>
        </div>
            ...
            @if($orders->count())
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="btn  @if($orders->previousPageUrl()) prev @else disabled @endif" data-shopid="{{$shop_id}}" data-href="{{$orders->previousPageUrl()}}" href="javascript:void(0)">
                            ...
                            <li class="page-item">
                                <a class="btn  @if($orders->nextPageUrl()) next @else disabled @endif" data-shopid="{{$shop_id}}" data-href="{{$orders->nextPageUrl()}}" href="javascript:void(0)">
                              <span class="polaris-icon">
                                <svg class="polaris-icon__svg" viewBox="0 0 20 20">
                                  <path
