                    ...
                    <div class="d-flex custom-top-div align-items-center">
                        <div class=" ">
                            <a style="text-decoration: none; color: black;"
                               href="{{route('admin.orders',$order_data->user_id)}}">
                                <ul class="pagination mb-0">
                                    <li class="page-item">
                                        <a class="btn" href="{{route('admin.orders',$order_data->user_id)}}">
                    ...
                    <div class="ml-5 " style="padding-left: 28px !important;">
                        <div>
                            <p style="margin-bottom: 0 !important;">{{ \Carbon\Carbon::parse($order_data->created_at)->format('F d, Y ')}}
                                at {{ \Carbon\Carbon::parse($order_data->created_at)->format('g:i A')}} from Online
                                Store</p></div>
                    </div>
                </div>
            </div>
                                ...
                                @if($line_item->fulfillment_status == null)
                                    ...
                                    <div class="custom align-items-center" style="">
                                        ...
                                        <div style="position: relative;" class="mr-3 custom-div-child2">
                                            ...
                                            <p class="mt-0">@if(isset($line_item->sku)){{"SKU: ".$line_item->sku}}@endif</p>
                                        </div>
                                ...
                                @foreach($order_fulfillments as $order_fulfillment)
                                    @foreach(json_decode($order_fulfillment->line_items) as $line_item )
                                        <div class="custom align-items-center" style="">
                                            <div class="mr-3 custom-div-child1">
                                                @php
                                                    $order = \App\ModelsOrder::where('shopify_order_id',$order_fulfillment->order_id)->first();
                                                @endphp
                                                <img style="padding: 2px;"
                                                     src="@foreach (json_decode($order->line_items) as $order_line_item )
                                                     @if($order_line_item->id == $line_item->id)
                                ...
                                <div class="d-flex justify-content-between">
                                    <div style="width: 60%;">
                                        <p class="">@if(isset($shipping_address->first_name)){{$shipping_address->first_name}}@endif @if(isset($shipping_address->last_name)){{$shipping_address->last_name}}@endif
                                            ...
                                            @if(isset($shipping_address->address1)){{$shipping_address->address1}}<br>@endif
                                            @if( isset($shipping_address->address2) && $shipping_address->address2 != ''){{$shipping_address->address2}}<br>@endif
                            ...
                            <div class="">
                                ...
                                @if(isset($billing_address))
                                    <p class="">
                                        ...
                                        <br> @if(isset($billing_address->address1)){{$billing_address->address1}}<br>@endif
                                        @if(isset($billing_address->address2) && $billing_address->address2 != ''){{$billing_address->address2}}<br>@endif
